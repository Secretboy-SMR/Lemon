...
namespace Lemonade.Net
{
    ...
    public class IKCP
    {
        ...
        // encode  bits unsigned int (lsb)
        public static void ikcp_encode64u(byte[] p, int offset, ulong l)
        {
            p[offset + 0] = (byte)(l & 0xFF);
            p[offset + 1] = (byte)(l >> 8);
            p[offset + 2] = (byte)(l >> 16);
            p[offset + 3] = (byte)(l >> 24);
            p[offset + 4] = (byte)(l >> 32);
            p[offset + 5] = (byte)(l >> 40);
            p[offset + 6] = (byte)(l >> 48);
            p[offset + 7] = (byte)(l >> 56);
        }

        public static ulong ikcp_decode64u(byte[] p, ref int offset)
        {
            int pos = offset;
            offset += 8;
        ...
        internal class Segment
        {
            ...
            internal void Encode(byte[] ptr, ref int offset)
            {
                ...
                ikcp_encode64u(ptr, offset, conv);
        ...
        public IKCP(ulong conv, object user)
        {
